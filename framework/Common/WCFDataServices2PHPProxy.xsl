...
<xsl:stylesheet version="1.0"
    ...
    xmlns:schema_1_3="http://schemas.microsoft.com/ado/2009/11/edm"
...
&lt;?php
   ...
   */
    ...
    */
    ...
    <xsl:apply-templates select="/edmx:Edmx/edmx:DataServices/schema_1_0:Schema | /edmx:Edmx/edmx:DataServices/schema_1_1:Schema | /edmx:Edmx/edmx:DataServices/schema_1_2:Schema | /edmx:Edmx/edmx:DataServices/schema_1_3:Schema" />
?&gt;
  </xsl:template>

  <xsl:template match="/edmx:Edmx/edmx:DataServices/schema_1_0:Schema | /edmx:Edmx/edmx:DataServices/schema_1_1:Schema | /edmx:Edmx/edmx:DataServices/schema_1_2:Schema | /edmx:Edmx/edmx:DataServices/schema_1_3:Schema">
    <xsl:apply-templates select="schema_1_0:EntityContainer | schema_1_1:EntityContainer | schema_1_2:EntityContainer | schema_1_3:EntityContainer"/>
    <xsl:for-each select="schema_1_0:EntityType | schema_1_1:EntityType | schema_1_2:EntityType | schema_1_3:EntityType">
      <xsl:apply-templates select="."/>
    </xsl:for-each>
    <xsl:for-each select="schema_1_0:ComplexType | schema_1_1:ComplexType | schema_1_2:ComplexType | schema_1_3:ComplexType">
      <xsl:apply-templates select="."/>
    </xsl:for-each>
  </xsl:template>
  ...
  <xsl:template match="schema_1_0:EntityContainer | schema_1_1:EntityContainer | schema_1_2:EntityContainer  | schema_1_3:EntityContainer">
    ...
    <xsl:variable name="service_namespace_2" select="concat($service_namespace_1, //schema_1_2:EntityType/../@Namespace)" />
    <xsl:variable name="service_namespace" select="concat($service_namespace_2, //schema_1_3:EntityType/../@Namespace)" />
   /**
    ...
    */
    ...
    {
    <xsl:for-each select="schema_1_0:EntitySet | schema_1_1:EntitySet | schema_1_2:EntitySet | schema_1_3:EntitySet">
        ...
        */
        public function __construct($uri = "")
        {
            ...
            $this->_entities = array(<xsl:for-each select="schema_1_0:EntitySet | schema_1_1:EntitySet | schema_1_2:EntitySet| schema_1_3:EntitySet">
                                "<xsl:value-of select="@Name"/>"<xsl:if test="position() != last()">,</xsl:if>
                     </xsl:for-each>);
            $this->_entitySet2Type = array(<xsl:for-each select="schema_1_0:EntitySet | schema_1_1:EntitySet | schema_1_2:EntitySet | schema_1_3:EntitySet">
            ...
            $this->_entityType2Set = array(<xsl:for-each select="schema_1_0:EntitySet | schema_1_1:EntitySet | schema_1_2:EntitySet | schema_1_3:EntitySet">
  ...
  <xsl:template match="schema_1_0:EntityType |schema_1_1:EntityType |schema_1_2:EntityType |schema_1_3:EntityType">
    <xsl:variable name="service_namespace_1" select="concat(//schema_1_0:EntityType/../@Namespace, //schema_1_1:EntityType/../@Namespace)" />
    <xsl:variable name="service_namespace_2" select="concat($service_namespace_1, //schema_1_2:EntityType/../@Namespace)" />
    <xsl:variable name="service_namespace" select="concat($service_namespace_2, //schema_1_3:EntityType/../@Namespace)" />
   /**
    * @class:<xsl:value-of select="@Name"/>
    * @type:EntityType<xsl:for-each select="schema_1_0:Key | schema_1_1:Key | schema_1_2:Key | schema_1_3:Key">
      <xsl:for-each select="schema_1_0:PropertyRef | schema_1_1:PropertyRef | schema_1_2:PropertyRef | schema_1_3:PropertyRef">
    ...
    */
    ...
    <xsl:for-each select="schema_1_0:Property | schema_1_1:Property | schema_1_2:Property | schema_1_3:Property">
       /**
    ...
    <xsl:for-each select="schema_1_0:NavigationProperty | schema_1_1:NavigationProperty | schema_1_2:NavigationProperty | schema_1_3:NavigationProperty">
       /**
    ...
    <xsl:for-each select="schema_1_0:Property[@Nullable = 'false'] | schema_1_1:Property[@Nullable = 'false'] | schema_1_2:Property[@Nullable = 'false'] | schema_1_3:Property[@Nullable = 'false']">
        * @param <xsl:value-of select="@Type"/> $<xsl:value-of select="@Name"/>
    </xsl:for-each>
        */
        public static function Create<xsl:value-of select="@Name"/>(<xsl:for-each select="schema_1_0:Property[@Nullable = 'false'] | schema_1_1:Property[@Nullable = 'false'] | schema_1_2:Property[@Nullable = 'false'] | schema_1_3:Property[@Nullable = 'false']">
            $<xsl:value-of select="@Name"/><xsl:if test="position() != last()">, </xsl:if>
    </xsl:for-each>)
        {   <xsl:variable name="ClassName" select="@Name"/>
            $<xsl:value-of select="@Name"/> = new <xsl:value-of select="@Name"/>();<xsl:for-each select="schema_1_0:Property[@Nullable = 'false'] | schema_1_1:Property[@Nullable = 'false'] | schema_1_2:Property[@Nullable = 'false'] | schema_1_3:Property[@Nullable = 'false']">
  ...
  <xsl:template match="schema_1_0:ComplexType |schema_1_1:ComplexType |schema_1_2:ComplexType |schema_1_3:ComplexType">
    <xsl:variable name="service_namespace_1" select="concat(//schema_1_0:ComplexType/../@Namespace, //schema_1_1:ComplexType/../@Namespace)" />
    <xsl:variable name="service_namespace_2" select="concat($service_namespace_1, //schema_1_2:ComplexType/../@Namespace)" />
      <xsl:variable name="service_namespace" select="concat($service_namespace_2, //schema_1_3:ComplexType/../@Namespace)" />
    /**
    * @class:<xsl:value-of select="@Name"/>
    * @type:ComplexType
    */
  ...
  <xsl:template match="schema_1_0:Key | schema_1_1:Key | schema_1_2:Key| schema_1_3:Key">
    <xsl:for-each select="schema_1_0:PropertyRef | schema_1_1:PropertyRef | schema_1_2:PropertyRef| schema_1_3:PropertyRef">
